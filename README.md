...
* Moguænost uvida u kriminalni dosije svakog pojedinca(ukoliko ga ima), što može zaista korisno biti pojedincu prilikom sklapanja trgovinskih ili bilo kakvih ugovora ili upoznavanja
* Brza razmijena informacija izmeðu policijskih službenika, kao i brz uvid u stanje sluèajeva 
* Moguænost praæenja rada policijskih službenika 
* Stvaranje jednog osjaæaja kolektivne odgovornosti i stida kod pojedinca ukoliko se naðe u bazi podataka

**Akteri**

* Sluzbena lice (Policajac) 
* Službena lice (Inspektor)
* Službeno lice (Komesar)
